...
class Hooks
{
     ...
     */
    const MINIMAL_TRANSLATION_CODES = ['fr_FR', 'fr_BE', 'fr_CA', 'it_IT', 'pl_PL', 'ro_RO', 'nl_BE', 'nl_NL_formal', 'nl_NL', 'tr_TR', 'ru_RU', 'bg_BG', 'cs_CZ', 'da_DK', 'sv_SE', 'fi', 'el', 'pt_BR', 'pt_PT', 'es_AR', 'es_CL', 'es_CO', 'es_CR', 'es_ES', 'es_GT', 'es_MX', 'es_PE', 'es_UY', 'es_VE'];
    /**
