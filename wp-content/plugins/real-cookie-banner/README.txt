...
Legally, the obligation is based on the [ePrivacy Directive](https://eur-lex.europa.eu/legal-content/EN/ALL/?uri=CELEX%3A32002L0058), which describes that setting of cookies that are not strictly technically necessary requires the explicit consent of the user (see in [Directive 2009/136/EG Rectial 66](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=celex%3A32009L0136)). The ePrivacy Directive has not yet been transposed into national law by many EU countries, but it must be applied nevertheless. The CURIA clarified on October 1, 2019 in [case C-673/17](https://devowl.io/go/curia-c-673-17) that e.g. the German special way of an opt-out procedure is not in accordance with the ePrivacy Directive. Since then, it must be assumed that only the opt-in procedure is permissible. This was also confirmed by the Federal Court of Justice for Germany on May 28, 2020 ([Case I ZR 7/16](https://devowl.io/de/go/bgh-i-zr-7-16) - Cookie Consent II). In the meantime, the German legislator has introduced the [TTDSG](https://dsgvo-gesetz.de/ttdsg/25-ttdsg/) to comply with the ePrivacy Directive.
